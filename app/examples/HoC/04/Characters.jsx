...
// Order matters
export default withData(options)(withLoader(HoCCharacters4)); //etsi fortwnei o loader etsi wste an exoume loaders se polles selides na ton tropopoioume mono se ena simeio
