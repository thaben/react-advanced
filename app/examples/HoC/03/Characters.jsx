...
export default withData(options)(HoCCharacters3); //girnaw ena component pisw
//arxika stelnw to options k meta afou oloklirothei meta log HOC k curring stelnei to HoCcharacters3
